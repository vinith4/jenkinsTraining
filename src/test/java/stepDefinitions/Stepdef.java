...
public class Stepdef extends BaseClass
{
	...
	public void user_enters_Email_as_and_Password_as(String email, String password) {
		...
		logger.info("************* entered user and password on application $$$$*****************" + email + ": "+ password);
	}
	...
	public void user_enter_customer_info() throws InterruptedException {
						...
						//random number --- asdaGGJkjew_ibm@gmail.com
		String email = randomestring() + "_genpact@gmail.com";
		
		String email_7 = randomestring(7) + "_genpact@gmail.com";
		
		logger.info("Random number generated by lib methods: " + email + " : " + email_7);
		System.out.println("**************************" + email + " : " + email_7);
